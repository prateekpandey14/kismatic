...
var commentMap = map[string]string{
	...
	"features.heapster.storage.persistent_volume_claim":  "Provide the name of the persistent volume claim that you will create after installation. If not specified, the data will be stored in ephemeral storage.",
}
